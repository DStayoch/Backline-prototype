...
assert.match(app, /navigator\.serviceWorker\s+\.register\("\.\/service-worker\.js\?v=20260822-auth-gate", \{ scope: "\.\/" \}\)/);
...
assert.match(serviceWorker, /const BACKLINE_CACHE = "backline-pwa-20260822-3"/);
