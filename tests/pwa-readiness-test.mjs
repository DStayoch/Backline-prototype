...
assert.match(app, /navigator\.serviceWorker\s+\.register\("\.\/service-worker\.js\?v=20260829-role-preview-dock-compact", \{ scope: "\.\/" \}\)/);
...
assert.match(serviceWorker, /const BACKLINE_CACHE = "backline-pwa-20260829-33"/);
