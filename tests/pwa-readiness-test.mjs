...
assert.match(app, /navigator\.serviceWorker\s+\.register\("\.\/service-worker\.js\?v=20260821-offline-sync", \{ scope: "\.\/" \}\)/);
...
assert.match(app, /const DATABASE_VERSION = 6/);
...
assert.match(serviceWorker, /const BACKLINE_CACHE = "backline-pwa-20260821-2"/);
