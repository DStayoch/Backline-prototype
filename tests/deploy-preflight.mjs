...
assert.match(betaDeploymentGuide, /supabase-schema-22-secure-sync\.sql/, "Beta deployment guide should use the latest schema cutoff.");
...
assert.match(supabaseProductionSetup, /supabase-schema-22-secure-sync\.sql/, "Supabase setup helper should use the latest schema cutoff.");
