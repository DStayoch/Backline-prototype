...
-- Plan seat limits (supabase-schema-25-subscription-seat-limits.sql).
...
-- Trial protection: one owned workspace per account (supabase-schema-26-single-owned-workspace.sql).
...
-- Customer-facing shop settings allowlist (supabase-schema-27-customer-safe-company-settings.sql).
